...
### الزامات
- تمام pluginهای این monorepo باید با PHP `8.1` تا `8.5` سازگار باشند.
- CI باید ماتریس `8.1`, `8.2`, `8.3`, `8.4`, `8.5` را پوشش دهد.
- استفاده از ویژگی‌های زبان که در `8.1` موجود نیستند ممنوع است مگر اینکه policy نسخه تغییر کند.
...
## 6) سازگاری با dependencyهای غایب
...
## 10) ماتریس بررسی سازگاری برای PR یا Agent Output
